...
<div className="h-screen">
  {/* Modal toggle */}
  <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" className="bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none" type="button">
    Toggle modal
  </button>
  {/* Main modal */}
        ...
        <form action="#">
          <div className="grid gap-4 grid-cols-2 py-4 md:py-6">
            ...
            <div className="col-span-2">
              ...
              <textarea id="description" rows={4} className="block bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full p-3.5 shadow-xs placeholder:text-body" placeholder="Write product description here" defaultValue={""} />                    
            </div>
          </div>
